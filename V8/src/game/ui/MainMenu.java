...
/**
 * This is the main menu screen where you pick the difficulty and see the leaderboard.
 */
public class MainMenu extends JPanel {
    // Called when the player picks a difficulty and starts the game
    private Consumer<Difficulty> onStartGame;
    // The difficulty the player selected
    private Difficulty selected = Difficulty.MEDIUM;
    // The list of high scores from the leaderboard
    private List<ScoreEntry> scores;
    // For pulsing animation on the title
    private float pulse=0f;
    // Timer for animation
    private final javax.swing.Timer anim;

    // All the colors used in the menu
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(GOLD);
        drawC(g2,"COMP SCI TOWER DEFENSE",w/2,138);
        ...
        drawC(g2,"Cannon $100 (splash)  ·  Sniper $150 (infinite range)  ·  Freeze $120 (slows)  ·  Mage $250 (chain lightning)",w/2,230);
