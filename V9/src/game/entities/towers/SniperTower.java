...
// The Sniper tower has infinite range and shoots one enemy at a time for massive damage
public class SniperTower extends Tower {
    ...
    // Make the sniper tower stronger when leveling up
    @Override
    ...
    public Projectile createProjectile() {
        ...
        // Higher levels fire faster and have more visible projectiles
        double speed = 100;
        int size = 4 + level;
