...
/**
 * BTD6-style side panel: dark brown theme, tower cards, upgrade panel, speed/pause controls.
 */
public class SidePanel extends JPanel {
    ...
    public void updateStats(int gold, int lives, int score, int wave, boolean waveInProgress,
                            boolean fast, boolean paused, boolean autostart) {
        ...
        int[] costs = {100, 150, 120, 250};
        for (int i = 0; i < towerBtns.length; i++) {
            boolean canAfford = gold >= costs[i];
